<template>
  <client-only>
    <v-row class="ma-0">
      <v-col cols="12" class="px-0 py-0"> <BannerGlobal></BannerGlobal></v-col>
              ...
              <!-- <v-tooltip bottom>
                <template v-slot:activator="{ on, attrs }">
                  <v-btn @click="getData" icon v-bind="attrs" v-on="on">
                    <v-icon color="primary" style="font-weight: 500">
                      mdi-magnify-expand
                    </v-icon>
                  </v-btn>
                </template>
            ...
            <v-row class="ma-0">
              <client-only>
                ...
                <!-- <v-col
                  ...
                  v-if="$store.state.app.requestObjectTypeID != 4"
                >
                  <v-card
                    flat
                    style="
                  ...
                  >
                    <v-row class="ma-0" no-gutters>
                      <v-col class="col-auto">
                        ...
                        >
                          THỐNG KÊ KIẾN NGHỊ THEO ĐỐI TƯỢNG GỬI
                        </div>
                      </v-col>
                    </v-row>
                    <v-row class="ma-0" no-gutters>
...
export default {
  ...
  methods: {
    ...
    resetData() {
      if (!this.typeShow) {
        this.$refs.MainObjectType.resetData()
      } else {
