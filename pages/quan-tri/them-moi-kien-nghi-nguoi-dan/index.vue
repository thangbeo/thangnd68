        ...
        <v-row class="ma-0">
          ...
          <v-col cols="4" class="py-0">
            ...
            <v-select
              ...
              dense
              v-model="objectType"
              :items="[{ text: 'Tổ chức cá nhân', value: 1 }]"
              readonly
            ></v-select>
          </v-col>
          <!-- <v-col
      ...
      this.$store
        ...
        .then((res) => {
          if (res.data.error.code === 0) {
            ...
            this.$router.push('/kien-nghi/danh-sach-kien-nghi-nguoi-dan')
          }
        })
    },
    requestUnApproval() {
    ...
    insertRequest() {
      ...
      this.$store.dispatch('request/requestSystemAdd', data).then((res) => {
        if (res.data.error.code === 0) {
          ...
          this.$router.push('/quan-tri/danh-sach-kien-nghi-nguoi-dan')
          this.$store.commit('request/setDataDetailRequest', null)
