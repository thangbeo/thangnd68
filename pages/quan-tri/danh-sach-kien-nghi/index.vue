                ...
                <td>
                  <div>
                    ...
                    <div
                      v-if="
                        data.item.requestObjectTypeName ==
                          'Đại biểu Quốc hội' && data.item.requestUnit != null
                      "
                    >
                      (ĐOÀN ĐBQH {{ data.item.requestUnit.fullName }})
                    </div>
                  </div>
                </td>
          ...
          <v-row class="ma-0" no-gutters align="center">
            ...
            >
              <v-btn
                ...
                color="#f2973a"
                to="/quan-tri/them-moi-kien-nghi"
                >Thêm kiến nghị
              </v-btn>
            </v-col>
            <v-spacer></v-spacer>
...
import HeaderFull from '~/components/danh-sach-kien-nghi/header/HeaderFull.vue'
import Rules from '~/assets/configurations/Rules'
import updatePage from '~/pages/quan-tri/cap-nhat-kien-nghi/index.vue'
...
export default {
  ...
  methods: {
      ...
      this.$store
        ...
        .then((res) => {
          if (res.data.error.code === 0) {
            ...
            this.$router.push('/quan-tri/chi-tiet-kien-nghi')
          }
        })
    },
    update(item) {
      ...
      this.$store
        ...
        .finally(() => {
          // this.$router.push('/quan-tri/cap-nhat-kien-nghi')
        })
    },
    search(value) {
    ...
    getListRequest() {
      ...
      this.$store.dispatch('request/getListRequest', data).then((res) => {
        if (res.data.error.code === 0) {
          // console.log(res)
