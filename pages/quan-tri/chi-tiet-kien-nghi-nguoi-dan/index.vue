              ...
              <div v-if="!$isNullOrEmpty(item[1])">
                <div class="d-flex">
                  ...
                  >
                    ...
                    <span class="mx-1" v-if="item[1].createTime != null">
                      -</span
                    >
                  ...
                  <div
                    v-if="
                      item[1].fileAttach != null && breakpoint !== 'desktop'
                    "
                    class="pb-3"
                  >
                    <span class="ml-3">
                  ...
                  <v-menu
                    v-if="
                      $checkRole(
                        Rules.System.RequestManage.actions.updateAnswer,
                    ...
                    <v-list>
                      <v-list-item>
                        <v-btn
                          ...
                          small
                          @click="updateAnswer(item[1])"
                        >
                          Cập nhật</v-btn
                        >
                      </v-list-item>
                      <!-- <v-list-item>
                        <v-btn block depressed class="text-none error" small>
                          Xóa</v-btn
                        >
                      </v-list-item> -->
                    </v-list>
            ...
            <div class="py-1 mx-4">
              <div class="pb-3 d-flex align-center">
                ...
                <v-menu
                  v-if="
                    $checkRole(
                      Rules.System.RequestManage.actions.updateClarify,
                      Rules.System.RequestManage.id
                    )
                  "
                  bottom
                  ...
                  <v-list>
                    <v-list-item>
                      <v-btn
                        ...
                        class="text-none primary"
                        small
                        @click="updateClarify(dataSuccess[index - 1], item[0])"
                      >
                        Cập nhật</v-btn
                      >
                    </v-list-item>
              ...
              <div class="pt-3" v-if="item[0].questionContent != null">
                <div class="d-flex">
                  <span class="fs-14 black--text" style="font-weight: 700">
                    ...
                    <span class="mx-1" v-if="item[0].createTime != null">
                      -</span
                    >
              ...
              <div v-if="!$isNullOrEmpty(item[1])">
                <div class="d-flex">
                  ...
                  <div
                    v-if="
                      item[0].fileAttach != null && breakpoint !== 'desktop'
                    "
                    class="pb-3"
                  >
                    <span class="ml-3">
...
import AdditionalReply from '~/components/kien-nghi-nguoi-dan/chi-tiet/AdditionalReply.vue'
import InputReason from '~/components/kien-nghi-nguoi-dan/chi-tiet/InputReason.vue'
import UpdateReplyContent from '~/components/kien-nghi-nguoi-dan/chi-tiet/UpdateReplyContent.vue'
import UpdateClarify from '~/components/kien-nghi-nguoi-dan/chi-tiet/UpdateClarify.vue'
import moment from 'moment'
import Clarify from '~/components/kien-nghi-nguoi-dan/chi-tiet/Clarify.vue'
import jsCookie from 'js-cookie'
import RepRequest from '~/components/kien-nghi-nguoi-dan/chi-tiet/RepRequest.vue'
import ConfirmRequest from '~/components/kien-nghi-nguoi-dan/chi-tiet/ConfirmRequest.vue'
import InputReasonUnit from '~/components/kien-nghi-nguoi-dan/chi-tiet/InputReasonUnit.vue'

import CardGlobal from '~/components/CardGlobal.vue'
import RequestCoordination from '~/components/kien-nghi-nguoi-dan/chi-tiet/RequestCoordination.vue'
export default {
