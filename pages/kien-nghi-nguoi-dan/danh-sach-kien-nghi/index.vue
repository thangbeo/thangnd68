      ...
      <CardGlobal>
        ...
        >
          ...
          <span v-if="!this.$isNullOrEmpty(objectTypeName)"
            >- {{ objectTypeName }}</span
          >
          <span v-if="!this.$isNullOrEmpty(fieldName)">- {{ fieldName }}</span>
            ...
            <v-row class="ma-0 pb-2" align="center">
              <v-col class="col-auto py-1">
                <div style="font-size: 16px; color: red !important">
                  Tổng số kiến nghị: {{ $formatMoney({ amount: totalReqest }) }}
                </div>
              </v-col>
              <v-spacer></v-spacer>
            ...
            >
              ...
              <td>
                <!-- <div>
                  ...
                  <div
                    v-if="
                      data.item.requestObjectTypeName == 'Đại biểu Quốc hội' &&
                      data.item.requestUnit != null
                    "
                  >
